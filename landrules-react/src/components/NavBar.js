    ...
    return (
        <Menu onClick={handleclick} selectedKeys={[current]} mode="horizontal" theme="dark">
            <Menu.Item>
              ...
              <span stroke="white" marginLeft="100px" width="26" height="17">LandRules</span>
            </Menu.Item>
            
            <Menu.Item className="menu-item" key="form"  style={{float: "right"}}>
              <Link to="/form">Form</Link>
            </Menu.Item>
            <Menu.Item className="menu-item" key="register"  style={{float: "right"}}>
              <Link to="/register">Register</Link>
            </Menu.Item>
            <Menu.Item className="menu-item" key="login"  style={{float: "right"}}>
              <Link to="/login">Login</Link>
            </Menu.Item>
            <Menu.Item className="menu-item" key="home"  style={{float: "right"}}>
              <Link to="/">Home</Link>
            </Menu.Item>
        </Menu>
    );
